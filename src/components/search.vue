<template>
  ...
  <div class="search" :class="{focused: focused}">
    ...
    <div class="input-wrap" @click="goSearch">
      <input type="text" v-model="str" @confirm="confirm_search" @input="onInput" :placeholder="placeholder">
      <span class="cancle" @click.stop="cancleSearch">取消</span>
    </div>
    <!-- 搜索结果 -->
    <div class="content">
      <div class="title">搜索历史<span @click="remove_local" class="clear"></span></div>
  ...
  export default {
    data () {
      return {
        ...
        history:uni.getStorageSync("history") || [] //历史记录数据列表
      }
    },
    methods: {
